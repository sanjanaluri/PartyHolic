        ...
        <div class="w-full h-full">
          ...
          <div class="mt-2">
            ...
            <div class="mt-2">
              ...
              <div class="relative">
              <select class="block appearance-none w-full bg-gray-200 border focus:border-purple-500 focus:bg-white focus:outline-none text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                <option>Male</option>
